...
public class OGCProxyExceptionID {
	...
	public static final OGCProxyExceptionID INITIALIZATION_NOT_PERFORMED =
			new OGCProxyExceptionID("OGCProxyException Initialization Exception: " +
	...
	public static final OGCProxyExceptionID UNSUPPORTED_CONTENT_FOR_REQUEST_METHOD =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Content in request body unsupported for client request method."
					, 0x03002);
	public static final OGCProxyExceptionID URL_PARSING_EXCEPTION =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Syntax error parsing server URL."
					, 0x03003);
	public static final OGCProxyExceptionID CLIENT_PROTOCOL_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Client protocol error."
					, 0x03004);
	public static final OGCProxyExceptionID SERVER_REQUEST_IO_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: I/O error on server request."
					, 0x03005);
	public static final OGCProxyExceptionID SERVER_RESPONSE_INPUT_STREAM_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Error obtaining input stream for server response."
					, 0x03006);
	public static final OGCProxyExceptionID CLIENT_RESPONSE_OUTPUT_STREAM_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Error obtaining output stream for client response."
					, 0x03007);
	public static final OGCProxyExceptionID SERVER_TO_CLIENT_RESPONSE_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Error copying server response to client."
					, 0x03008);
	...
	public static final OGCProxyExceptionID UTIL_GZIP_COMPRESSION_ERROR =
			new OGCProxyExceptionID("OGCProxyException Util Exception: Gzip compression error."
					, 0x04000);
	public static final OGCProxyExceptionID GZIP_ERROR =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Error uncompressing server gzip content."
					, 0x04001);
	public static final OGCProxyExceptionID GZIP_NOT_UTF8 =
			new OGCProxyExceptionID("OGCProxyException Proxy Exception: Server gzip content is not UTF-8."
					, 0x04002);
	...
	public static final OGCProxyExceptionID INVALID_SERVER_RESPONSE_ENCODING =
			new OGCProxyExceptionID("OGCProxyException WQPUtil Exception: Invalid content encoding."
					, 0x05000);

	public static final OGCProxyExceptionID INVALID_SERVER_RESPONSE_CODE =
			new OGCProxyExceptionID("OGCProxyException WQPUtil Exception: Invalid response code."
					, 0x05001);
	...
	public static final OGCProxyExceptionID DATAFILE_PARSING_ERROR =
			new OGCProxyExceptionID("OGCProxyException LayerBuilder Exception: Unable to parse datafile for search params."
					, 0x06000);
	public static final OGCProxyExceptionID SHAPEFILE_CREATION_ERROR =
			new OGCProxyExceptionID("OGCProxyException LayerBuilder Exception: Unable to create shapefile for search params."
					, 0x06001);
	public static final OGCProxyExceptionID GEOTOOLS_FEATUREBUILDER_ERROR =
			new OGCProxyExceptionID("OGCProxyException LayerBuilder Exception: Unable to create GeoTools SimpleFeatureBuilder."
					, 0x06002);
	public static final OGCProxyExceptionID SIMPLESTATION_FILE_ERROR =
			new OGCProxyExceptionID("OGCProxyException LayerBuilder Exception: Did not get SimpleStation XML file."
					, 0x06003);
